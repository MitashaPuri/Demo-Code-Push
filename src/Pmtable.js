...
fetch(url, requestOptions)
  ...
  return (
    ...
    <div>
                      ...
                      <form>
                        ...
                        <div className="col-md-3 col-sm-3">
                          ...
                          >
                            ...
                            <i className="fa-solid fa-angle-down arrow-icon" style={{marginTop:"13px"}}></i>
                            </div>
                            </div>
                          ...
                          >
                            ...
                            <Button onClick={handleGo} style={{height:"33px"}}>
                             Go 
                            </Button>
                          </div>
                          ...
                          >
                            <div className="form-group">
                            <Button onClick={handleDownloadClick} style={{height:"33px"}}>
                              <i
     ...
     {showError ? (
     <div id="errorDiv">
          <b style={{ color: "red", fontSize: "12px",marginLeft:"3%" }}>
