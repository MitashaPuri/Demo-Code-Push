...
const [chartDataForSocial, setchartDataForSocial] = useState({
  ...
  const fetchMessages4 = async () => {
    try { 
      ...
      //  const response1 = await axios.get('https://uatajna1.omfysgroup.com//api/messages/topic4');
...
// fetch("https://uatajnaapi1.omfysgroup.com/get_analytics_data", requestOptions)
...
// fetch("https://uatajnaapi1.omfysgroup.com/get_View_data", requestOptions)
  .then(response => response.text())
