      ...
      //   console.log(emp_name);
        ...
        if (newdata.error) {
          ...
          if (newdata.EMP_CODE === value) {
            const totalWorkingHours = newdata.Response.total_working_hours;
            const employee_availability1 = newdata.Response.total_availability;
            // empppp=newdata.Response.employee_name;
            const employee_availability = parseFloat(employee_availability1.toFixed(1));
...
console.log("Fourth Percentage_of_Training_proj: " + parsedValue[3].Percentage_of_Training_proj);
          ...
          setChartData12({
            ...
            options: {
              ...
              colors: ["#00A3AD","#00637C", "#FADA5E", "#F08080"],
            },
          });
...
//   callEmp();
// };
// const [Asso, setAss] = useState(''); // State to manage selected associate name
// const [isLoading, setIsLoading] = useState(false); // State to manage loading
// const [employee1, setEmployee1] = useState([/* employee list goes here */]);
...
const callEmployee = async (event) => {
  ...
  try {
    ...
    setIsLoading(false); // Stop the loader after the API call
  }
};
                      ...
                      <div className="row">
                        <div className="col-md-12">
                          <div className="form-group">
                            <label htmlFor="exampleInputEmail1" style={{display:"flex",borderBottom:"1.5px solid grey"}}>
    ...
    <div className="col-md-6">
      {/* <div className="form-group">
        ...
        <div className="custom-select-container">
         ...
         {/* <select value={Asso} onChange={changeAsso} >
            <option value="mitasha puri">MITASHA</option>
            <option value="Yasha">Yashashri</option>
            <option value="seja">sejal</option>
            <option value="mitasha">gayatri</option>
