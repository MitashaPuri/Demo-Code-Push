...
//alert("select"+userResponsibilities);
 ...
 if (checked) {
        setSelectedResponsibilities([...selectedResponsibilities, value]); // Update selected responsibilities array
            ...
            <div className="col-sm-12 col-md-10 col-lg-10 mx-auto">
              <div className="card shadow mb-4">
                <div className="card-body">
                  ...
                  <div>
                    <table id="myTable" className="table table-sm table-striped  table-responsive p-0" style={{maxWidth:"80%",marginLeft:"9%",maxHeight:"250px"}}>
                      ...
                      <tbody style={{ color: "black"}}>
                        {currentUsers.map((user, index) => (
                          <tr key={user.EMP_CODE}>
                            ...
                            <td>
  {/* Check if Responsibility is an array, if so, join; otherwise, display it as a string */}
  {Array.isArray(user.Responsibility) 
